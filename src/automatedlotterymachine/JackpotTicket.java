 ...
 * @author gabegm
 */
public class JackpotTicket extends Ticket {
    private static int id;
    private final double ticketValue;
    private final List<Integer> numbers;

    /**
     * Constructor to the JackpotTicket class
     * @param numbers 
     */
    public JackpotTicket(List<Integer> numbers) {
        ++id;
        this.setId(id);
        this.numbers = numbers;
        this.ticketValue = 3.00;
    }
    ...
    public String toString() {
        return "JackpotTicket{" + "id=" + id + ", ticketValue=" + ticketValue + ", numbers=" + numbers + '}';
    }
